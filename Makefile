...
# Generated by qmake (3.0) (Qt 5.0.2) on: Tue Feb 4 16:45:34 2014
...
LIBS          = $(SUBLIBS) /home/linux/dragoncoin/src/leveldb/libleveldb.a /home/linux/dragoncoin/src/leveldb/libmemenv.a -lrt -lssl -lcrypto -ldb_cxx -lboost_system -lboost_filesystem -lboost_program_options -lboost_thread -lQt5Widgets -L/usr/lib/i386-linux-gnu -lQt5Network -lQt5Gui -lQt5Core -lpthread -lGL 
AR            = ar cqs
RANLIB        = 
...
clean:compiler_clean 
	-$(DEL_FILE) $(OBJECTS)
	-$(DEL_FILE) /home/linux/dragoncoin/src/leveldb/libleveldb.a; cd /home/linux/dragoncoin/src/leveldb ; $(MAKE) clean
	-$(DEL_FILE) *~ core *.core
...
/home/linux/dragoncoin/src/leveldb/libleveldb.a: FORCE
	cd /home/linux/dragoncoin/src/leveldb && CC=gcc CXX=g++ $(MAKE) OPT="-pipe -fstack-protector-all -D_FORTIFY_SOURCE=2 -O2" libleveldb.a libmemenv.a

/home/linux/dragoncoin/build/build.h: FORCE
	cd /home/linux/dragoncoin; /bin/sh share/genbuild.sh /home/linux/dragoncoin/build/build.h
