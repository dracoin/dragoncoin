...
"Copyright &copy; 2011-YYYY The Dragoncoin developers"));
    ...
    {
        AboutDialog->setWindowTitle(QApplication::translate("AboutDialog", "About Dragoncoin", 0));
        label->setText(QApplication::translate("AboutDialog", "<b>Dragoncoin</b> version", 0));
